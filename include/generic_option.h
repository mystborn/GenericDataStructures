...
#define OPTION_DEFINE_H(type_name, function_prefix, value_type) \
 ...
 \
    ...
    static inline value_type function_prefix ## _value(type_name optional) { assert(optional.has_value); return optional.value; } \
...
#define gds_option_value(optional) (assert((optional).has_value), (optional).value)
